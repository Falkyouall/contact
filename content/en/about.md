...
On the frontend I mainly use React, Vue, and TypeScript. On the backend it's Node.js, Next.js, and NestJS. I'm comfortable with cloud platforms like GCP, AWS, and Azure, and I use Pulumi and Terraform for infrastructure. For databases I typically reach for PostgreSQL or Firebase. I work with GraphQL, REST, and gRPC depending on the project.
